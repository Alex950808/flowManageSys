            ...
            <el-row class="bgDiv">
                <el-col :span="22" :offset="1">
                    <div class="tableTitleStyle">
                        <el-row>
                            <el-col :span="12">
                                <span class="bgButton MR_ten" @click="backUpPage()">返回上一页</span><span><span class="coarseLine"></span>&nbsp;&nbsp;&nbsp;商品报价新品列表</span>
                            </el-col>
                            <el-col :span="12" class="fontRight">
                                <span class="bgButton MR_ten" @click="d_table()">下载商品报价新品</span>
                            </el-col>
                        </el-row>
                    </div>
...
export default {
  ...
  methods:{
    getDataList(){
        let vm = this;
        vm.tableData=JSON.parse(sessionStorage.getItem("SGDL"));
    },
    //下载表格 
    d_table(){
        let vm=this;
        ...
        let tableName = "商品报价新品"+"_"+vm.checkTime(month)+"."+vm.checkTime(date);
        axios({ // 用axios发送post请求
          method: 'post',
          url: vm.url+vm.$downloadSaleDiffGoodsURL, // 请求地址
