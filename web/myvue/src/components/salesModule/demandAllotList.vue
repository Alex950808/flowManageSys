                ...
                <el-col :span="22" :offset="1">
                    <div class="demandAllotList">
                        <el-row class="purchaseTitle listTitleStyle">
                            <el-col :span="24">
                                <span><span class="coarseLine"></span>&nbsp;&nbsp;&nbsp;待分配需求列表</span>
                        ...
                        <ul>
                            <li class="purchaseContent" v-for="item in tableData">
                                <el-row>
                                    <el-col :span="24">
                                        <div class="demandTitle lineHeightForty">
                                            <el-col :span="20">
                                                需求单号:{{item.demand_sn}}
                                            </el-col>
                                            <el-col :span="4">
                                                <span class="notBgButton"><i class="el-icon-view" @click="goSummaryPage(item.demand_sn)">查看数据汇总</i></span>
                                            </el-col>
                                        </div>
  ...
  methods:{
     //获取需求列表数据
      getDemandData(){
        ...
        axios.get(vm.url+vm.$demandAllotListURL+'?start_page='+vm.page+'&page_size='+vm.pagesize+"&keywords="+vm.search,
          {
              headers:{
      ...
      viewDetails(purchase_sn,demand_sn){
          ...
          switchLoading(event);
          let headersToken=sessionStorage.getItem("token");
          axios.get(vm.url+vm.$demandPurchaseDetailURL+"?purchase_sn="+purchase_sn+"&demand_sn="+demand_sn,
            {
                headers:{
                    'Authorization': 'Bearer ' + headersToken,
                    'Accept': 'application/vnd.jmsapi.v1+json',
              ...
              if(res.data.code==1000){
                  ...
                  vm.$router.push('/demandPurchaseDetail?purchase_sn='+purchase_sn+"&isDetail=isDetail");
