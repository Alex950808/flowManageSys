<template>
  <div class="seeCustomsClearance_b">
    <!-- 查看清关订单页面 -->
        <el-col :span="24" class="PR Height" style="background-color: #fff;">
            <el-row class="bgDiv">
                <fontWatermark :zIndex="false"></fontWatermark>
                <el-col :span="22" :offset="1">
                    <div class="seeCustomsClearance">
                        <el-row class="tableTitleStyle">
                            <el-col :span="10">
                                <div>
                                    <span><span class="coarseLine"></span>&nbsp;&nbsp;&nbsp;查看待清关订单</span>
                                    <searchBox @searchFrame='searchFrame'></searchBox>
                                </div>  
                            </el-col>
                            <el-col :span="14">
                                <span class="bgButton floatRight MT_twenty MR_twenty" @click="confirmShow()">上传待清关订单</span>
...
export default {
    ...
    methods: {
        ...
        getCustomsData(){
            ...
            axios.get(vm.url+vm.$sellCusOrderURL+"?page="+vm.page+"&pagesize="+vm.pagesize+"&keywords="+vm.search,
                {
                    headers:{
