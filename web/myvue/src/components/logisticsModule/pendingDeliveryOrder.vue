<template>
  <div class="pendingDeliveryOrder_b">
    <!-- 待发货订单页面 -->
        <el-col :span="24" class="PR Height" style="background-color: #fff;">
            <el-row class="bgDiv">
                <fontWatermark :zIndex="false"></fontWatermark>
                <el-col :span="22" :offset="1">
                    <el-row class="pendingDeliveryOrder">
                        <el-row>
                            <el-col :span="10">
                                <div class="title tableTitleStyle">
                                    <span><span class="coarseLine"></span>&nbsp;&nbsp;&nbsp;待发货订单</span>
...
export default {
    ...
    methods: {
        ...
        getPendingOrderData(){
            let vm=this;
            axios.get(vm.url+vm.$LigWaitOrderURL+"?keywords="+vm.search+"&page="+vm.page+"&pagesize="+vm.pagesize,
                {
...
.pendingDeliveryOrder .ellipsis span{
    width: 180px;
    display: -webkit-box;
    line-height: 23px;
    /* autoprefixer: off */
...
.pendingDeliveryOrder .file {
    position: relative;
    display: inline-block;
    text-align: center;
}
.pendingDeliveryOrder .file img{
  padding-top: 20px;
}
.pendingDeliveryOrder .file span{
  display: inline-block;
  width: 120px;
  height: 27px;
  font-size: 10px;
...
.pendingDeliveryOrder .file input {
    position: absolute;
    /* font-size: 100px; */
    right: 0;
    top: 0;
...
.pendingDeliveryOrder .upLoadImg{
    width: 120px;
    height: 120px; 
}
.pendingDeliveryOrder .download{
    display: inline-block;
    color: #7092ce;
    margin-right: 20px;
}
