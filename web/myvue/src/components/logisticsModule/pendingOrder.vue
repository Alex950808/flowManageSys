<template>
  <div class="pendingOrder_b">
    <!-- 待转关订单页面 -->
        <el-col :span="24" class="PR Height" style="background-color: #fff;">
            <el-row class="bgDiv">
                <fontWatermark :zIndex="false"></fontWatermark>
                <el-col :span="22" :offset="1">
                    <el-row class="pendingOrder">
                        <el-row class="tableTitleStyle">
                            <el-col :span="10">
                                <div>
                                    <span><span class="coarseLine"></span>&nbsp;&nbsp;&nbsp;待转关订单</span>
...
export default {
    ...
    methods: {
        ...
        getPendingOrderData(){
            ...
            axios.get(vm.url+vm.$getCusTransitOrderURL+"?keywords="+vm.search+"&page="+vm.page+"&pagesize="+vm.pageSize,
                {
