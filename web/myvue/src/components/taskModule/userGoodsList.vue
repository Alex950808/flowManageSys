      ...
      <el-col :span="24" style="background-color: #fff;">
            <el-row>
                <el-col :span="22" :offset="1">
                    <div class="quotationDetails bgDiv">
                        <el-row class="title">
                            <el-col :span="12">
                                <router-link  to='/saleUserList'><span class="back bgButton MR_ten">返回上一级</span></router-link>
                                ...
                                <div class="ee">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th :colspan="rateTdWidth">
                                                自采毛利率<i class="el-icon-circle-plus" @click="dialogVisible = true"></i>
                                                <template>
                                                    <el-popover  placement="top-start" width="200" trigger="click"
                                                        content="销售毛利率-费用合计">
                                                        <i class="el-icon-question" slot="reference"></i>
...
export default {
  ...
  methods:{
    ...
    //   },
      ...
      getlistData(arr_erp_no){
          let vm=this;
          let headersToken=sessionStorage.getItem("token");
          vm.erpInfo.splice(0);
          vm.departments.splice(0);
          axios.get(vm.url+vm.$userGoodsListURL+"?sale_user_id="+vm.$route.query.sale_user_id+"&arrErpNo="+arr_erp_no+"&store_id="+vm.storeId+"&department_id="+vm.department+"&pageSize="+vm.pagesize+"&page="+vm.page,
                {
                    headers:{
            ...
            axios.post(vm.url+vm.$batchSaleDisURL,
                    {
                        ...
                        "store_id":vm.storeId,
                        // "department_id":vm.department,
                        "arr_erp_no":JSON.stringify(arr_erp_no),
                    ...
                    if(res.data.code==2024){
                        vm.getlistData(JSON.stringify(arr_erp_no));
                        vm.dialogVisibleRate = false;
                    }else{
                        vm.$message(res.data.msg);
                    }
...
.quotationDetails_b .cc{width:100%; border-bottom:1px solid #ccc; background:#fff; overflow:auto;}
